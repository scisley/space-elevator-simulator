...
export const MILESTONES = [
  ...
  {
    altitude: 1000,
    label: "Boundary of Low Earth Orbit",
    sublabel: "1,000 km",
  },
  {
    altitude: 2000,
    label: "Inner Van Allen Radiation Belt",
    sublabel: "2,000 km",
  },
  {
    altitude: 12550,
    label: "One Earth Diameter Above Surface",
    sublabel: "12,550 km",
  },
  {
    altitude: 20200,
    label: "GPS Satellite Constellation Orbit",
    sublabel: "20,200 km",
  },
  {
    altitude: 35786,
    label: "Geostationary Orbit — Zero Gravity",
    sublabel: "35,786 km",
  },
  {
    altitude: 75600,
    label: "1/5 of the Way to the Moon",
    sublabel: "75,600 km",
  },
...
export const TRAVEL_DURATION_MS =
  (CABLE_LENGTH / DEFAULT_SPEED_KMH) * 3_600_000; // one-way travel
...
export const MAG_BOOTS_FORCE = 9.8; // m/s² (1g pull toward standing surface)
